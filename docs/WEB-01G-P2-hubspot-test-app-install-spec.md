...
- Workflows
- Files
- Sensitive or highly-sensitive CRM data
- Custom objects

If the HubSpot consent screen requests anything beyond the six required scopes above, stop before installation.
...
- HubSpot does not classify the account as `DEVELOPER_TEST`;
- consent requests any scope outside the six listed above;
- the installation page targets real portal `247013136`;
